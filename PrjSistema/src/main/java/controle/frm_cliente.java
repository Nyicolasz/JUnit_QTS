...
public class frm_cliente extends JFrame {
    ...
    JLabel rcod, rnome, rtel, rend, rpesquisa,labelImagem;
    JTextField tcod, tnome, tend, tpesquisa;
    JFormattedTextField ftel;
    MaskFormatter mtel;
    ...
    public frm_cliente() {
        ...
        rend = new JLabel("Endereço:");
        rpesquisa = new JLabel("Pesquisar Nome :");
        ...
        rtel.setBounds(115, 110, 100, 30);
        rend.setBounds(115, 140, 100, 30); tend.setBounds(175, 150, 200, 20);
        ...
        tend.setBackground(new Color(255,214,73));
        ...
        try {
            ...
            ftel = new JFormattedTextField(mtel);
        } catch (ParseException excp) {
            excp.printStackTrace();
        }
        
        ftel.setBackground(new Color(255,214,73));
        ftel.setBounds(175, 115, 200, 20);
...
primeiro.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    if(tcod.getText().equals("")){
                        ...
                        sql = "update cliente set nome_cliente='" + nome + "', telefone_cliente='" + telefone + "', endereco_cliente='" + endereco + "' where cod_cliente=" + tcod.getText();
   ...
   btnpesquisar.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e) {    
                try {
                    String pesquisa = "select * from cliente where nome_cliente like '"+tpesquisa.getText() +"%'";
        ...
        try {
            ...
            while(con_pizzaria.resultset.next()) {
                modelo.addRow(new Object[] {
                    ...
                    con_pizzaria.resultset.getString("nome_cliente"),
                    con_pizzaria.resultset.getString("telefone_cliente"),
                    con_pizzaria.resultset.getString("endereco_cliente")
                });
            }
        }catch(SQLException erro){
    ...
    public void mostrar_Dados() {
        try {
            tcod.setText(con_pizzaria.resultset.getString("cod_cliente")); // associar a caixa de texto ao campo cod
            tnome.setText(con_pizzaria.resultset.getString("nome_cliente")); // associar a caixa de texto ao campo nome
            ftel.setText(con_pizzaria.resultset.getString("telefone_cliente"));
            tend.setText(con_pizzaria.resultset.getString("endereco_cliente"));
        } catch(SQLException erro) {
